...
var generateNewUsername = function (num, done) {
    return "Aiden \uD83E\uDDD8\uD83C\uDFFB\u200D\u2642\uFE0F ".concat(done ? num + 1 : num, "/7");
};
var generateNewLocation = function (location, done) {
    var day = new Date().getDay();
    var startChar = location.indexOf("⚪️⚪️⚪️⚪️⚪️⚪️⚪️");
    var newLocation = location.substring(0, startChar + day * 2) +
        (done ? "🟢" : "⚪️") +
...
var job = new cron.CronJob("0 12 * * *", initDailyCheck, null, true, timezone);
job.start();
